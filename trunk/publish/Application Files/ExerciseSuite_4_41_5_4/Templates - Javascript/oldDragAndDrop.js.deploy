...
document.write('<table width="80%" border="0" cellspacing="0" cellpadding="3"><tr><td align="left" valign="top" width="50%"><b><font size="2">Complete these beginnings...</font></b></td><td align="left" valign="top" width="50%"><b><font size="2">by dragging these endings.</font></b></td></tr></table>');

document.write('<div id="dragdropdiv"/><!-- needed in order calculate where the question squares begin --><table width="80%" border="0" cellspacing="1" cellpadding="10" bgcolor="silver"><tr><td align="center" valign="top" bgcolor="white">');

document.write('<style type="text/css">');
document.write('div.CardStyleF { position: absolute; font-family: Lucida Grande, Arial Unicode MS, Sans Serif; font-size: ' + optionCardFontSize + '; padding: 8px; border-style: solid; border-width: 1px; color: #333333; background-color: #eeeeee; left: -50px; top: -50px; overflow: visible; text-align: right; }');
document.write('    div.CardStyleD { position: absolute; font-family: Lucida Grande, Arial Unicode MS, Sans Serif; font-size: ' + optionCardFontSize + '; padding: 8px; border-style: solid; border-width: 1px; color: #333333; background-color: #eeeeee; left: -50px; top: -50px; overflow: visible; text-align: left; }');
...
//Calculate page dimensions and positions
	pg = new PageDim();
	DivWidth = Math.floor(pg.W*0.8);
	DragWidth = Math.floor((DivWidth*3)/10);
  LeftColPos = Math.floor(pg.W/10) + 10;
